...
const BODY_PATHS: Record<BodyShapeId, string> = {
  ...
  angledSignTile: 'M28 14 L82 22 C86 23 88 27 87 32 L79 78 C78 84 72 88 50 90 C28 88 18 82 16 75 L13 29 C12 23 18 15 28 14 Z',

  dashboardCard: 'M17 16 L83 16 C87 16 90 19 90 23 L90 78 C90 84 85 89 79 89 L21 89 C15 89 10 84 10 78 L10 23 C10 19 13 16 17 16 Z',
  metricTile: 'M21 18 L79 18 C84 18 87 22 87 27 L87 77 C87 83 82 88 76 88 L24 88 C18 88 13 83 13 77 L13 27 C13 22 16 18 21 18 Z',
  appWindow: 'M16 14 L84 14 C88 14 91 17 91 21 L91 79 C91 85 86 90 80 90 L20 90 C14 90 9 85 9 79 L9 21 C9 17 12 14 16 14 Z',
  alertPill: 'M28 18 L72 18 C84 18 91 30 91 44 L91 60 C91 76 80 88 50 88 C20 88 9 76 9 60 L9 44 C9 30 16 18 28 18 Z',
};
